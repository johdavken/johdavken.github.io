...
test("tablet and desktop hide the redundant tracking bar; compact mobile keeps its aria-live status", () => {
  ...
  assert.match(block, /#splitsArea > \.splitsTrackingBar\{ display:none; \}/);
});
