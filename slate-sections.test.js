...
test("the rail draws a glyph for every section the boot defines", () => {
  ...
  assert.deepEqual(icons, ["home", "recipe", "book", "weights", "balance", "guide", "guide", "workspaces", "lines", "resins", "gauge", "winding", "settings", "timeline"],
    "the boot's sections changed: a phone's Home, Recipe, Recipe Book, Weights, Resin Balance, How to Use and its Hopper Weights Configuration, the administrator's three, the two Tools, Settings; the aside's Timeline");
