...
test("the rail draws a glyph for every section the boot defines", () => {
  ...
  assert.deepEqual(icons, ["recipe", "book", "weights", "balance", "workspaces", "lines", "resins", "gauge", "winding", "settings", "timeline"],
    "the boot's sections changed: Recipe, Recipe Book, Weights, Resin Balance, the administrator's three, the two Tools, Settings; the aside's Timeline");
