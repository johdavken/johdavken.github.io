(function (root, factory) {
  ...
  const RESIN_FIELDS = "id,resin_code,density_g_cm3,bulk_density_lb_ft3,is_active,updated_at";
  ...
  function validateResin(values){
    ...
    return { valid: true, value: { resin_code, density_g_cm3, bulk_density_lb_ft3, is_active: !!values?.is_active } };
  }
