...
test("it is a real disclosure button, naming the sections it controls", () => {
  ...
  // of them on its own.
  assert.match(block, /aria-controls="workspaceNavLineSync workspaceNavNotes workspaceNavTools helpBetaAccess workspaceNavChangelog workspaceNavSlate workspaceNavSudo"/);
