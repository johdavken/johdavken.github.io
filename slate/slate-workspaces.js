/* Workspaces: the lines this Supabase project holds, and the
 * administrator's way to put a reset device back on one.
 *
 ...
 * on the server. This section is how an administrator attaches the
 * browser's CURRENT identity to that line as an ordinary member. It never
 * restores the old identity and never hands over ownership by itself.
 *
...
(function (root, factory) {
  ...
  const SOON = "The lines, their devices and Add This Device arrive in the next phase.";
